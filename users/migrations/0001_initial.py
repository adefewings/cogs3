    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason_for_account', models.TextField(blank=True, max_length=1024, verbose_name='Reason for account')),
                ('accepted_terms_and_conditions', models.BooleanField(default=False, verbose_name='Terms and Conditions')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uid_number', models.PositiveIntegerField(blank=True, null=True, verbose_name='UID Number')),
                ('description', models.CharField(blank=True, max_length=200)),
                ('phone', models.CharField(blank=True, max_length=15)),
                ('account_status', models.PositiveSmallIntegerField(choices=[(0, 'Awaiting Approval'), (1, 'Approved'), (2, 'Declined'), (3, 'Revoked'), (4, 'Suspended'), (5, 'Closed')], default=0, verbose_name='Current Status')),
                ('previous_account_status', models.PositiveSmallIntegerField(choices=[(0, 'Awaiting Approval'), (1, 'Approved'), (2, 'Declined'), (3, 'Revoked'), (4, 'Suspended'), (5, 'Closed')], default=0, verbose_name='Previous Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shibboleth_id', models.CharField(blank=True, help_text='Institutional address', max_length=254)),
