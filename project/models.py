...
class Project(models.Model):
    ...
    allocation_storage_scratch = models.PositiveIntegerField(
        ...
        help_text=_('Scratch storage is short-term, high-performance parallel file storage used for intermediary data you need temporarily but will either delete or move off the system once it is no longer needed. There is a 1 TBytes user quota on Hawk and 20 TBytes on Sunbird. When the scratch filesystem approaches full capacity, old unused files will be deleted.'),
    )
